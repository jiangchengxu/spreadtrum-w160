...
public:
    ...
    BOOL m_bBigDaddy;
    BOOL m_buttonpressed;//add by liub
public:
    CButtonST();
    ~CButtonST();
...
public:
    ...
    DWORD SetIcon(int nIconInId, int nIconOutId = NULL,int nIconPressId = NULL);//modify by liub (新添了第三个参数)
    DWORD SetIcon(HICON hIconIn, HICON hIconOut = NULL,HICON hIconPress = NULL);//modify by liub (新添了第三个参数)
...
#pragma pack()
    ...
    STRUCT_ICONS    m_csIcons[3];//modify by liub
