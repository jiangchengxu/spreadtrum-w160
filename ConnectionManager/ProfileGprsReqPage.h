// --------------------------------------------------------------------------
//
// ProfileGprsReqPage.h
//
/// ProfileGprsReqPage interface.
///
/// @file
//
...
{
public:
    ProfileGprsReqPage(WDSGetDefaultSettingsRspRCP rspRCP);
    ProfileGprsReqPage(WDSGetProfileSettingsRspRCP rspRCP);
