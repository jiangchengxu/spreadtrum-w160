...
USES_CONVERSION;
    ...
    {
        if (profileName.Compare(_T("")) == 0) { profileName = _T("NULL"); }
    ...
    {
        if (apnName.Compare(_T("")) == 0) { apnName = _T("NULL"); }
    ...
    {
        if (username.Compare(_T("")) == 0) { username = _T("NULL"); }
    ...
    {
        if (password.Compare(_T("")) == 0) { password = _T("NULL"); }
