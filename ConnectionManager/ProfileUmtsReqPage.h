// --------------------------------------------------------------------------
//
// ProfileUmtsReqPage.h
//
/// ProfileUmtsReqPage interface.
///
/// @file
//
...
// ProfileUmtsReqPage
//
/// The ProfileUmtsReqPage class represents the controls under the umts req
/// qos tab of the profile sheet. Input from the user and output to the user
/// under the general tab is controlled by this class.
// --------------------------------------------------------------------------

class ProfileUmtsReqPage : public ProfileSheetPage
{
public:
    ProfileUmtsReqPage(WDSGetDefaultSettingsRspRCP rspRCP);
    ProfileUmtsReqPage(WDSGetProfileSettingsRspRCP rspRCP);
