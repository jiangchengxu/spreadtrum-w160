// --------------------------------------------------------------------------
//
// WDSCreateProfileMsg.h
//
/// WDSCreateProfileReq/WDSCreateProfileRsp interface.
///
/// @file
//
...
// --------------------------------------------------------------------------
class WDSCreateProfileReq;
class WDSCreateProfileRsp;
typedef TRCPointer<WDSCreateProfileReq> WDSCreateProfileReqRCP;
typedef TRCPointer<WDSCreateProfileRsp> WDSCreateProfileRspRCP;
...
// WDSCreateProfileRsp
//
/// This class represents a QMI_WDS_CREATE_PROFILE_RESP message which is the
/// response to the wds create profile request.
// --------------------------------------------------------------------------

class WDSCreateProfileRsp : public Message
{
    // define tlv types
...
protected:
    ...
    virtual bool UnpackProfileIdentifier(MsgBuf& msgBuf);
