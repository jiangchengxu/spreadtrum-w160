// --------------------------------------------------------------------------
//
// WDSGetDefaultSettingsMsg.cpp
//
/// WDSGetDefaultSettingsReq/WDSGetDefaultSettingsRsp implementation.
///
/// @file
//
...
// --------------------------------------------------------------------------
static MessageCreator<WDSGetDefaultSettingsReq> ReqStringCreator("QMI_WDS_GET_DEFAULT_SETTINGS_REQ");
static MessageCreator<WDSGetDefaultSettingsReq> ReqUint32Creator(WDSGetDefaultSettingsReqUID);

static MessageCreator<WDSGetDefaultSettingsRsp> RspStringCreator("QMI_WDS_GET_DEFAULT_SETTINGS_RSP");
static MessageCreator<WDSGetDefaultSettingsRsp> RspUint32Creator(WDSGetDefaultSettingsRspUID);

// --------------------------------------------------------------------------
// WDSGetDefaultSettingsReq
// --------------------------------------------------------------------------
...
// dtor
//
/// Destructor for WDSGetDefaultSettingsReq.
// --------------------------------------------------------------------------
WDSGetDefaultSettingsReq::~WDSGetDefaultSettingsReq()
{}
...
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsReq::Build(std::string& nameValue)
{
...
/// @returns bool - true if build successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsReq::BuildProfileType(std::string& value)
{
    uint32 num;
...
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsReq::BuildMsgBuf()
{
...
// --------------------------------------------------------------------------
void WDSGetDefaultSettingsReq::Print(std::ostream& stream)
{
...
// --------------------------------------------------------------------------
// WDSGetDefaultSettingsRsp
// --------------------------------------------------------------------------

// --------------------------------------------------------------------------
// ctor
//
/// Constructor for WDSGetDefaultSettingsRsp.
// --------------------------------------------------------------------------
const uint8 WDSGetDefaultSettingsRsp::RESULT_CODE_TYPE = 0x02;
const uint8 WDSGetDefaultSettingsRsp::PROFILE_NAME_TYPE = 0x10;
const uint8 WDSGetDefaultSettingsRsp::PDP_TYPE_TYPE = 0x11;
const uint8 WDSGetDefaultSettingsRsp::APN_NAME_TYPE = 0x14;
const uint8 WDSGetDefaultSettingsRsp::PRIMARY_DNS_IPV4_ADDR_PREF_TYPE = 0x15;
const uint8 WDSGetDefaultSettingsRsp::SECONDARY_DNS_IPV4_ADDR_PREF_TYPE = 0x16;
const uint8 WDSGetDefaultSettingsRsp::UMTS_REQUESTED_QOS_TYPE = 0x17;
const uint8 WDSGetDefaultSettingsRsp::UMTS_MINIMUM_QOS_TYPE = 0x18;
const uint8 WDSGetDefaultSettingsRsp::GPRS_REQUESTED_QOS_TYPE = 0x19;
const uint8 WDSGetDefaultSettingsRsp::GPRS_MINIMUM_QOS_TYPE = 0x1A;
const uint8 WDSGetDefaultSettingsRsp::USERNAME_TYPE = 0x1B;
const uint8 WDSGetDefaultSettingsRsp::AUTH_PREF_TYPE = 0x1D;
const uint8 WDSGetDefaultSettingsRsp::IPV4_ADDR_PREF_TYPE = 0x1E;
WDSGetDefaultSettingsRsp::WDSGetDefaultSettingsRsp() :
    Message(QMUX_TYPE_WDS,QMI_WDS_GET_DEFAULT_SETTINGS_MSG,QMI_CTL_FLAG_TYPE_RSP),
...
// dtor
//
/// Destructor for WDSGetDefaultSettingsRsp.
// --------------------------------------------------------------------------
WDSGetDefaultSettingsRsp::~WDSGetDefaultSettingsRsp()
{}
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackResultCode(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackProfileName(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackPdpType(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackApnName(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackPrimaryDnsIpv4AddrPref(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackSecondaryDnsIpv4AddrPref(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackUmtsRequestedQos(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackUmtsMinimumQos(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackGprsRequestedQos(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackGprsMinimumQos(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackUsername(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackAuthPref(MsgBuf& msgBuf)
{
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSGetDefaultSettingsRsp::UnpackIpv4AddrPref(MsgBuf& msgBuf)
{
...
/// @param stream - the ostream to print to.
// --------------------------------------------------------------------------
void WDSGetDefaultSettingsRsp::Print(std::ostream& stream)
{
    stream << "QMI_WDS_GET_DEFAULT_SETTINGS_RESP" << std::endl
           << _T("{") << std::endl
