// --------------------------------------------------------------------------
//
// WDSGetDefaultSettingsMsg.h
//
/// WDSGetDefaultSettingsReq/WDSGetDefaultSettingsRsp interface.
///
/// @file
//
...
// --------------------------------------------------------------------------
// Unique identifiers for WDSGetDefaultSettingsMsg types
// --------------------------------------------------------------------------
static const uint32 WDSGetDefaultSettingsReqUID =
    (QMUX_TYPE_WDS << 24 |
     QMI_CTL_FLAG_TYPE_CMD << 16 |
     QMI_WDS_GET_DEFAULT_SETTINGS_MSG);
static const uint32 WDSGetDefaultSettingsRspUID =
    (QMUX_TYPE_WDS << 24 |
...
// --------------------------------------------------------------------------
class WDSGetDefaultSettingsReq;
class WDSGetDefaultSettingsRsp;
typedef TRCPointer<WDSGetDefaultSettingsReq> WDSGetDefaultSettingsReqRCP;
typedef TRCPointer<WDSGetDefaultSettingsRsp> WDSGetDefaultSettingsRspRCP;


// --------------------------------------------------------------------------
// WDSGetDefaultSettingsReq
//
/// This class represents a QMI_WDS_GET_DEFAULT_SETTINGS_REQ message which
/// retrieves the default data session settings.
// --------------------------------------------------------------------------

class WDSGetDefaultSettingsReq : public Message
{
    // define tlv types
    static const uint8 PROFILE_TYPE_TYPE;
...
private:
    // Profile Type, mandatory tlv 0x01
    uint8 m_profileTypeType;
    uint16 m_profileTypeLen;
    uint8 m_profileType;
};
...
//
/// This class represents a QMI_WDS_GET_DEFAULT_SETTINGS_RESP message which
/// is the response to the wds get default settings request.
// --------------------------------------------------------------------------

class WDSGetDefaultSettingsRsp : public Message
{
    // define tlv types
