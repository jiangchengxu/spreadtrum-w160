// --------------------------------------------------------------------------
//
// WDSModifyProfileSettingsMsg.cpp
//
/// WDSModifyProfileSettingsReq/WDSModifyProfileSettingsRsp implementation.
///
/// @file
//
...
// --------------------------------------------------------------------------
static MessageCreator<WDSModifyProfileSettingsReq> ReqStringCreator("QMI_WDS_MODIFY_PROFILE_SETTINGS_REQ");
static MessageCreator<WDSModifyProfileSettingsReq> ReqUint32Creator(WDSModifyProfileSettingsReqUID);

static MessageCreator<WDSModifyProfileSettingsRsp> RspStringCreator("QMI_WDS_MODIFY_PROFILE_SETTINGS_RSP");
static MessageCreator<WDSModifyProfileSettingsRsp> RspUint32Creator(WDSModifyProfileSettingsRspUID);
...
// ctor
//
/// Constructor for WDSModifyProfileSettingsReq.
// --------------------------------------------------------------------------
const uint8 WDSModifyProfileSettingsReq::PROFILE_IDENTIFIER_TYPE = 0x01;
const uint8 WDSModifyProfileSettingsReq::PROFILE_NAME_TYPE = 0x10;
const uint8 WDSModifyProfileSettingsReq::PDP_TYPE_TYPE = 0x11;
const uint8 WDSModifyProfileSettingsReq::APN_NAME_TYPE = 0x14;
const uint8 WDSModifyProfileSettingsReq::PRIMARY_DNS_IPV4_ADDR_PREF_TYPE = 0x15;
const uint8 WDSModifyProfileSettingsReq::SECONDARY_DNS_IPV4_ADDR_PREF_TYPE = 0x16;
const uint8 WDSModifyProfileSettingsReq::UMTS_REQUESTED_QOS_TYPE = 0x17;
const uint8 WDSModifyProfileSettingsReq::UMTS_MINIMUM_QOS_TYPE = 0x18;
const uint8 WDSModifyProfileSettingsReq::GPRS_REQUESTED_QOS_TYPE = 0x19;
const uint8 WDSModifyProfileSettingsReq::GPRS_MINIMUM_QOS_TYPE = 0x1A;
const uint8 WDSModifyProfileSettingsReq::USERNAME_TYPE = 0x1B;
...
// dtor
//
/// Destructor for WDSModifyProfileSettingsReq.
// --------------------------------------------------------------------------
WDSModifyProfileSettingsReq::~WDSModifyProfileSettingsReq()
{}
...
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::Build(std::string& nameValue)
{
...
/// @returns bool - true if build successful.
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::BuildProfileType(std::string& value)
{
    uint32 num;
...
/// @returns bool - true if build successful.
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::BuildPdpType(std::string& value)
{
    uint32 num;
...
/// @returns bool - true if build successful.
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::BuildReqTrafficClass(std::string& value)
{
    uint32 num;
...
/// @returns bool - true if build successful.
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::BuildMinTrafficClass(std::string& value)
{
    uint32 num;
...
/// @returns bool - true if build successful.
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::BuildReqPrecedenceClass(std::string& value)
{
    uint32 num;
...
/// @returns bool - true if build successful.
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::BuildMinPrecedenceClass(std::string& value)
{
    uint32 num;
...
/// @returns bool - true if build successful.
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::BuildAuthPref(std::string& value)
{
    uint32 num;
...
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsReq::BuildMsgBuf()
{
...
// --------------------------------------------------------------------------
void WDSModifyProfileSettingsReq::Print(std::ostream& stream)
{
    stream << "QMI_WDS_MODIFY_PROFILE_SETTINGS_REQ" << std::endl
           << _T("{") << std::endl
...
// ctor
//
/// Constructor for WDSModifyProfileSettingsRsp.
// --------------------------------------------------------------------------
const uint8 WDSModifyProfileSettingsRsp::RESULT_CODE_TYPE = 0x02;
WDSModifyProfileSettingsRsp::WDSModifyProfileSettingsRsp() :
    Message(QMUX_TYPE_WDS,QMI_WDS_MODIFY_PROFILE_SETTINGS_MSG,QMI_CTL_FLAG_TYPE_RSP),
...
// dtor
//
/// Destructor for WDSModifyProfileSettingsRsp.
// --------------------------------------------------------------------------
WDSModifyProfileSettingsRsp::~WDSModifyProfileSettingsRsp()
{}
...
/// @returns bool - true if unpack successful.
// --------------------------------------------------------------------------
bool WDSModifyProfileSettingsRsp::UnpackResultCode(MsgBuf& msgBuf)
{
...
/// @param stream - the ostream to print to.
// --------------------------------------------------------------------------
void WDSModifyProfileSettingsRsp::Print(std::ostream& stream)
{
    stream << "QMI_WDS_MODIFY_PROFILE_SETTINGS_RESP" << std::endl
           << _T("{") << std::endl
