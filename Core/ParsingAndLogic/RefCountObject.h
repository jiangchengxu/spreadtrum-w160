...
public:
    ...
    MyType& Create() {
        Set(THeapObject<_PT>::Create());
        return *this;
    }

    template<typename _T1>
    MyType& Create(const _T1& arg1) {
        Set(THeapObject<_PT>::Create(arg1));
        return *this;
    }
    ...
    MyType& Create(
        ...
        Set(THeapObject<_PT>::Create(arg1,arg2));
        return *this;
    }
    ...
    MyType& Create(
        ...
        Set(THeapObject<_PT>::Create(arg1,arg2,arg3));
        return *this;
    }
    ...
    MyType& Create(
        ...
        Set(THeapObject<_PT>::Create(arg1,arg2,arg3,arg4));
        return *this;
    }
};
